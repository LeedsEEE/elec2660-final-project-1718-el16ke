...
- (void)viewDidLoad {
    ...
    self.RobotDescriptionLabel.text = @"Pick a Robot";
...
- (void)pickerView:(UIPickerView *)pickerView
    ...
    if ([tempTitle isEqualToString:@"Spawn of Scutter"]) {
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Spawn.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Bulldog.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Firestorm.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"King.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Thermidor"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Panic.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Anarchy.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"BigBro.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Terror.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Scutter.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Brucs.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Behemoth.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Crank.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"Body Hammer.png"];
        ...
        self.RobotImage.image = [UIImage imageNamed:@"terminator.png"];
